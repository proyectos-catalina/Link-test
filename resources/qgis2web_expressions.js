...
function exp_PuntosResiduosSolidos_1rule0_eval_expression(context) {
    // "Nombre " ILIKE '%respel%'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Nombre ').toLowerCase().indexOf('respel'.toLowerCase()) > -1);
    } else {
        return (feature.get('Nombre ').toLowerCase().indexOf('respel'.toLowerCase()) > -1);
    }
}
...
function exp_PuntosResiduosSolidos_1rule1_eval_expression(context) {
    // "Nombre " ILIKE '%Batea%'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Nombre ').toLowerCase().indexOf('Batea'.toLowerCase()) > -1);
    } else {
        return (feature.get('Nombre ').toLowerCase().indexOf('Batea'.toLowerCase()) > -1);
    }
}
...
function exp_PuntosResiduosSolidos_1rule2_eval_expression(context) {
    // "Nombre " ILIKE '%acopio%'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Nombre ').toLowerCase().indexOf('acopio'.toLowerCase()) > -1);
    } else {
        return (feature.get('Nombre ').toLowerCase().indexOf('acopio'.toLowerCase()) > -1);
    }
}
...
function exp_PuntosResiduosSolidos_1rule3_eval_expression(context) {
    // fid = 33

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('fid')  == 33);
    } else {
        return (feature.get('fid')  == 33);
    }
}